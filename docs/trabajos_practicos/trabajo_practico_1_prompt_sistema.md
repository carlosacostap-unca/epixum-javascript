...

{
  ...
  "verdicto": "Elige estrictamente una de las tres opciones: 'Aprobado' (si la nota es mayor o igual a 6), 'Corregir y reenviar' (si la nota es menor a 6 pero el trabajo puede recuperarse con una nueva entrega) o 'Desaprobado' (si el trabajo no admite reenvío)"
}
